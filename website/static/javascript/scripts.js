...
(function (jQuery, window, undefined) {
    ...
    var attrFn = jQuery("<input/>", {size: 1}).attr("size") && jQuery.attrFn, oldAttr = jQuery.attr,
    ...
    var eventAdd = jQuery.event.add, eventRemove = jQuery.event.remove, eventTrigger = jQuery.event.trigger,
        ...
        rajaxEvent = new RegExp("\\b(?:" + ajaxEvents + ")\\b"), rhoverHack = /(?:^|\s)hover(\.\S+|)\b/,
    ...
    (function () {
        ...
        if (!f) {
            ...
            f.he = function () {
                ...
                var b = doc.createElement("length-calc"), c = doc.body || doc.documentElement, d = b.style, e = {},
                    g = ["mm", "cm", "in", "pt", "pc"], j = g.length, i = {};
                d.position = "absolute";
                d.top = d.left = "-9999px";
            ...
            f.Sb = f.B.ka({
                ...
                la: function (a) {
                    ...
                    var d = this.e.currentStyle, e, g, j, i = f.v.qa, h = i.pa, k = i.na, n = i.z, m, p, r = 0,
                        t = this.Pd, v, l, q = {M: []};
                    if (this.wb()) {
                        e = new f.v(a);
                        for (j = {}; g = e.next();) {
                ...
                Bc: function (a) {
                    var b = f.ja > 8, c = this.eb, d = this.e.runtimeStyle, e = d[c.da], g = d[c.z], j = d[c.T], i, h,
                        k, n;
                    if (e) d[c.da] = "";
                    if (g) d[c.z] = "";
                    if (j) d[c.T] = "";
            ...
            (function () {
                f.jb = f.B.ka({
                    wa: "border-radius", Fa: "borderRadius", la: function (b) {
            ...
            f.Ic = f.B.ka({
                wa: "box-shadow", Fa: "boxShadow", la: function (a) {
            ...
            f.u = {
                R: function (a) {
                    ...
                    e = g.h * b;
                    g = g.f * b;
                    var j = this.g.G, i = Math.floor, h = Math.ceil, k = a ? a.Jb * b : 0, n = a ? a.Ib * b : 0,
                        m = a ? a.tb * b : 0;
                    a = a ? a.Db * b : 0;
                    var p, r, t, v, l;
                    if (c || j.i()) {
            ...
            f.Tb = f.u.R({
                N: 5, Md: ["t", "tr", "r", "br", "b", "bl", "l", "tl", "c"], Q: function () {
                    return this.g.q.H()
                }, i: function () {
                    return this.g.q.i()
                }, V: function () {
            ...
            f.Hc = f.u.R({
                N: 1, Ya: "outset-box-shadow", Q: function () {
                    var a = this.g;
                    return a.ga.H() || a.G.H()
                }, i: function () {
                    var a = this.g.ga;
            ...
            f.Oc = f.u.R({
                ib: f.aa, Mb: f.aa, Nb: f.aa, Lb: f.aa, Ld: /^,+|,+$/g, Fd: /,+/g, gb: function (a, b) {
            ...
            f.Nc = f.u.R({
                T: "repeat", Sc: "stretch", Qc: "round", ua: 0, Q: function () {
                    return this.g.q.H()
                }, i: function () {
                    return this.g.q.i()
                }, V: function () {
                    var a = this, b = a.g.q.j(), c = a.g.w.j(), d = a.s.o(), e = b.repeat, g = e.f, j = e.Ob, i = a.e,
                        h = 0;
                    f.p.Rb(b.src, function (k) {
                        ...
                        z = z.l.a(i);
                        var C = m - u - x, F = p - o - y, O = r - z - E, H = t - B - D, M = g === q ? C : O * o / B,
                            P = j === q ? F : H * x / E, I = g === q ? C : O * y / D;
                        q = j === q ? F : H * u / z;
                        var K = [], J = [], G = 0;
                        if (g === k) {
                            M -= (M - (C % M || M)) / s(C / M);
            ...
            f.kb = function () {
                ...
                function d(l) {
                    function q() {
                        if (!U) {
                            var w, A, L = f.ja, T = l.currentStyle, N = T.getAttribute(g) === "true",
                                da = T.getAttribute(i) !== "false", ea = T.getAttribute(h) !== "false";
                            S = T.getAttribute(j);
                ...
                var e = {}, g = f.F + "lazy-init", j = f.F + "poll", i = f.F + "track-active", h = f.F + "track-hover",
                    k = f.La + "hover", n = f.La + "active", m = f.La + "focus", p = f.La + "first-child",
                    r = {background: 1, bgColor: 1, display: 1}, t = {}, v = [];
                d.yd = function (l) {
                    var q = f.p.Ba(l);
 ...
 */
!function (a) {
    "function" == typeof define && define.amd ? define(["static/javascript/jquery"], a) : a("object" == typeof module && module.exports ? require("static/javascript/jquery") : jQuery)
}(function (a) {
    function b(b) {
        var c = {}, d = /^jQuery\d+$/;
...
(function () {
    ...
    (function (t, e) {
        if (typeof define === "function" && define.amd) {
            return define("waypoints", ["static/javascript/jquery"], function (n) {
                return e(n, t)
            })
        } else {
            return e(t.jQuery, t)
...
(function ($) {
    $.fn.imageLens = function (options) {
        var defaults = {lensSize: 100, borderSize: 4, borderColor: "#888"};
...
(function () {
    ...
    if (!attachEvent) {
        ...
        function scrollListener(e) {
            ...
            animationstartevent = 'animationstart', domPrefixes = 'Webkit Moz O ms'.split(' '),
            startEvents = 'webkitAnimationStart animationstart oAnimationStart MSAnimationStart'.split(' '), pfx = '';
        {
...
;(function (factory) {
    if (typeof define === 'function' && define.amd) {
        define(['static/javascript/jquery'], factory)
    } else if (typeof exports === 'object') {
        module.exports = factory(require('static/javascript/jquery'))
    } else {
        factory(jQuery)
    }
}(function ($) {
...
!function a(b, c, d) {
    ...
    1: [function (a) {
        !function () {
            "use strict";
            var b = window.jQuery, c = a("./ChildrenWrapper"), d = a("./Child"), e = function (a) {
                this.el = a, this._makeOption();
                var d = b(a).children(), e = new c(this), f = 0;
            ...
            e.prototype.el = null, e.prototype.option = {animationDuration: 1e3}, e.prototype._makeOption = function () {
                (function () {
                ...
                var a, b = this, c = arguments[0], d = Array.prototype.slice.call(arguments, 1), f = b.length, g = 0;
                for (g; f > g; g += 1) if ("object" == typeof c || "undefined" == typeof c ? b[g].Carousel3d = new e(b[g], c) : a = b[g].Carousel3d[c].apply(b[g].Carousel3d, d), void 0 !== a) return a;
                return b
            }, b(function () {
                b("[data-carousel-3d]").Carousel3d()
            })
        }()
    }, {"./Child": 2, "./ChildrenWrapper": 3}], 2: [function (a, b) {
        !function () {
            "use strict";
            var a = window.jQuery, c = window.Modernizr, d = function (b, c) {
            ...
            d.prototype._childrenWrapperObj = null, d.prototype._content = null, d.prototype.el = null, d.prototype._contentWrapper = null, d.prototype._hideUntilLoad = function () {
                ...
                var b = a(this._frame).outerWidth() - a(this._frame).innerWidth(),
                    ...
                    f = (a(this.el).innerHeight() - d) / a(this._content).outerHeight(), g = Math.min(e, f),
        ...
        !function () {
            "use strict";
            var a = window.jQuery, c = function (b) {
            ...
            c.prototype.el = null, c.prototype._carousel3dObj = null, c.prototype._childObjArray = [], c.prototype._currentIndex = 0, c.prototype._tz = 0, c.prototype._spacing = .05, c.prototype.currentIndex = function (a) {
                ...
                this.currentIndex(b);
                var c = 360 / this._childObjArray.length, d = 0, e = 0;
                if (Modernizr.csstransforms3d) for (d = 0; d < this._childObjArray.length; d += 1) {
                    e = c * (d - b);
                    var f = "";
                    ...
                    var g = a(this.el).width(), h = a(this.el).height(), i = function (b, d) {
                        if ("_degree" === d.prop) {
                            var e = Math.sin(Math.PI / 180 * b), f = Math.cos(Math.PI / 180 * b), i = c / 2,
                                j = Math.abs(Math.sin(Math.PI / 180 * (b + i)) - Math.sin(Math.PI / 180 * (b - i))) / (2 * Math.sin(Math.PI / 180 * i)) * f,
                                k = (f + 1) / 2, l = (j + 1) / 2, m = (e * g / 2 + g * l / 2 * e) / 2;
                    ...
                    for (d = 0; d < this._childObjArray.length; d += 1) e = c * (d - b), a(this._childObjArray[d].el).animate({_degree: e}, {
        ...
        utils: {
            ...
            miscellaneous: function () {
                ...
                $('.slider-a > .inner').each(function () {
                    $(this).bxSlider({pager: false, controls: true, useCSS: false, adaptiveHeight: true});
                });
                ...
                $('#content.a > .vid figure a > .fit-a').each(function () {
                    $(this).css({'background-image': 'url("' + $(this).parents('figure').find('img').attr('src') + '")'});
                });
